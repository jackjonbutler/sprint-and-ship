...
description: |
  ...
  (MILESTONE-LEVEL ONLY — do not invoke per-phase)
...
<!-- modified from https://github.com/garrytan/gstack/blob/main/plan-eng-review/SKILL.md under MIT license; modifications: see ATTRIBUTIONS.md -->
...
<!-- vendored from mike-kirby-dev/dev-stack (itself modified from garrytan/gstack), MIT. Modifications for sprint-and-ship: attribution header + Notion plan-source note. See ATTRIBUTIONS.md + licenses/gstack-LICENSE -->
...
## sprint-and-ship note

The plan under review lives in the Notion ticket body under "## Implementation Plan". Fetch it from the ticket (TKT-<id>), review interactively, and write agreed amendments back to the same section with a "### Eng review amendments (<date>)" note. Recommended for L-estimate tickets before flipping AI Stage to Plan Approved.
